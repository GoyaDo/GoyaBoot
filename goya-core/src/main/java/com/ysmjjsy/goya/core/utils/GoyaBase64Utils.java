...
public class GoyaBase64Utils {
    ...
    public static byte[] decode(String base64) {
        ...
        try {
            ...
            throw new CommonException("Failed to decode Base64 string", e);
        }
    }
    ...
    public static byte[] decodeUrlSafe(String base64) {
        ...
        try {
            ...
            throw new CommonException("Failed to decode URL-safe Base64 string", e);
        }
    }
    ...
    public static byte[] decodeMime(String base64) {
        ...
        try {
            ...
            throw new CommonException("Failed to decode MIME Base64 string", e);
        }
    }
