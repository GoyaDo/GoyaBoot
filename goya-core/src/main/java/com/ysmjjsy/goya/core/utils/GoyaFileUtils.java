...
public class GoyaFileUtils {
    ...
    public static String readString(File file, Charset charset) {
        try {
            ...
            throw new CommonException("Failed to read file: " + file.getPath(), e);
        }
    }
    ...
    public static List<String> readLines(File file, Charset charset) {
        try {
            ...
            throw new CommonException("Failed to read lines from file: " + file.getPath(), e);
        }
    }
    ...
    public static byte[] readBytes(File file) {
        try {
            ...
            throw new CommonException("Failed to read bytes from file: " + file.getPath(), e);
        }
    }
    ...
    public static void writeString(File file, String content, Charset charset) {
        try {
            ...
            throw new CommonException("Failed to write string to file: " + file.getPath(), e);
        }
    }
    ...
    public static void writeLines(File file, List<String> lines, Charset charset) {
        try {
            ...
            throw new CommonException("Failed to write lines to file: " + file.getPath(), e);
        }
    }
    ...
    public static void writeBytes(File file, byte[] bytes) {
        try {
            ...
            throw new CommonException("Failed to write bytes to file: " + file.getPath(), e);
        }
    }
    ...
    public static void appendString(File file, String content, Charset charset) {
        try {
            ...
            throw new CommonException("Failed to append string to file: " + file.getPath(), e);
        }
    }
    ...
    public static void copyFile(File source, File target) {
        if (!source.exists()) {
            throw new CommonException("Source file does not exist: " + source.getPath());
        }
        if (source.isDirectory()) {
            throw new CommonException("Source is a directory, not a file: " + source.getPath());
        }
        try {
            mkdirs(target.getParentFile());
            Files.copy(source.toPath(), target.toPath(), StandardCopyOption.REPLACE_EXISTING);
        } catch (IOException e) {
            throw new CommonException("Failed to copy file from " + source.getPath() + " to " + target.getPath(), e);
        }
    }
    ...
    public static void copyDirectory(File source, File target) {
        if (!source.exists()) {
            throw new CommonException("Source directory does not exist: " + source.getPath());
        }
        if (!source.isDirectory()) {
            throw new CommonException("Source is not a directory: " + source.getPath());
        }
        try {
            mkdirs(target);
            ...
            throw new CommonException("Failed to copy directory from " + source.getPath() + " to " + target.getPath(), e);
        }
    }
    ...
    public static void moveFile(File source, File target) {
        ...
        try {
            ...
            throw new CommonException("Failed to move file from " + source.getPath() + " to " + target.getPath(), e);
        }
    }
    ...
    public static boolean deleteDirectory(File directory) {
        ...
        try {
            ...
            throw new CommonException("Failed to delete directory: " + directory.getPath(), e);
        }
    }
    ...
    public static List<File> listFilesRecursively(File directory) {
        ...
        try (Stream<Path> paths = Files.walk(directory.toPath())) {
            ...
            throw new CommonException("Failed to list files recursively: " + directory.getPath(), e);
        }
        return files;
    }
     ...
     * @param suffix 后缀
     * @return 临时文件
     * @throws CommonException 如果创建失败
     */
    public static File createTempFile(String prefix, String suffix) {
        try {
            return File.createTempFile(prefix, suffix);
        } catch (IOException e) {
            throw new CommonException("Failed to create temp file", e);
        }
    }
    ...
    public static File createTempFile(String prefix, String suffix, File directory) {
        try {
            ...
            throw new CommonException("Failed to create temp file in directory: " + directory.getPath(), e);
        }
    }
    ...
    public static File createTempDirectory(String prefix) {
        try {
            ...
            throw new CommonException("Failed to create temp directory", e);
        }
    }
}
